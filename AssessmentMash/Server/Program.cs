...
using AssessmentMash.Server.DataAccess;
...
builder.Services.AddTransient<IBuyerPost, AssessmentDataAccessLayer>();
builder.Services.AddTransient<ISellerPost, AssessmentDataAccessLayer>();
